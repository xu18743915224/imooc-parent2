...
insert  into `sys_menu`(`id`,`parent_id`,`icon_cls`,`text`,`url`,`status`,`no`,`create_user`,`create_time`,`update_user`,`update_time`) values (1,0,'fa fa-user','用户模块','yhmk',1,1,'system','2020-06-03 11:52:02','admin','2020-06-30 10:56:51'),(2,0,'fa fa-desktop','系统模块','xtmk',1,2,'sys','2020-06-03 12:00:17','admin','2020-06-29 10:27:42'),(15,1,'fa fa-user','用户管理','111',1,1,'admin','2020-06-29 11:53:33','admin','2020-06-30 10:56:12'),(27,1,'fa fa-paw','角色管理','dfdf',1,2,'admin','2020-06-30 10:53:32','admin','2020-06-30 10:53:32'),(28,1,'fa fa-sitemap','权限管理','qx',1,3,'admin','2020-06-30 10:55:58','admin','2020-06-30 10:55:58');
