...
insert  into `sys_menu`(`id`,`parent_id`,`icon_cls`,`text`,`url`,`status`,`no`,`create_user`,`create_time`,`update_user`,`update_time`) values (1,0,'111','菜单1','url',1,NULL,'system','2020-06-03 11:52:02','system',NULL),(2,0,'111','菜单2','url',1,NULL,'sys','2020-06-03 12:00:17','sys',NULL);
